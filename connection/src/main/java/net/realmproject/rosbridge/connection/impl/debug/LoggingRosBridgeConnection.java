...
public class LoggingRosBridgeConnection implements RosBridgeConnection {
    ...
    public LoggingRosBridgeConnection(RosBridgeConnection backer) {
        this(backer, new PrintWriter(System.out));
    }
    ...
    public LoggingRosBridgeConnection(RosBridgeConnection backer, final Writer log, final boolean logInput,
