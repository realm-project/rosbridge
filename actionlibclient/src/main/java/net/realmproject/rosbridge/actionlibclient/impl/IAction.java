...
public class IAction<T> implements Action<T> {
	...
	public IAction(RosBridgeClientFactory factory, String baseTopic, String baseType, Class<T> clazz) throws InterruptedException, IOException {
		...
		@Override
	public synchronized Goal<T> createGoal() throws InterruptedException, IOException {
